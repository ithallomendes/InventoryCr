...
@endif
<div class="card-body">
    <a href="{{route('subcategoria.create')}}" class="btn btn-success">Cadastrar</a>
</div>
    <div class="card">
        <div class="card-body">
            <table id="subcategoria" class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="200px">
                            ...
                            <a href="{{route('subcategoria.edit',$subcategoria)}}" class="btn btn-primary">Editar</a>
                                @method('delete')
                                @csrf
